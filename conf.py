...
BLOG_AUTHOR = "Members of the LUG Fulda"  # (translatable)
BLOG_TITLE = "Linux User Group Fulda"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://lugfd.de/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://lugfd.de/"
BLOG_EMAIL = "webmaster@lugfd.de"
BLOG_DESCRIPTION = "LUG Fulda Website"  # (translatable)
